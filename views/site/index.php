...
<div id="container">
        ...
        <script>
            ...
            $(".info_keys .tag").click(function () {
                if ($(this).hasClass('active')) {
                    ...
                    $(".info_choice").append("<div class='close_tag' data='" + tag + "'>" + tag + "<span><img src='/images/picts/close_v_pict.png'></span></div>");
                }
    ...
    <footer>
        <div class="container">
            ...
            <script type="text/javascript" src="https://mvariant.ru/js/fancybox/jquery.fancybox.js?v=2.1.5"></script>
            <link rel="stylesheet" type="text/css" href="https://mvariant.ru/js/fancybox/jquery.fancybox.css?v=2.1.5"
                  media="screen">
            ...
            <div class="left">
                <div class="logo_bottom"><a href="https://mvariant.ru/"><img
                                src="https://mvariant.ru/images/logo_bottom.png"></a></div>
            ...
            <div class="right">
                ...
                <noindex>
                    <a href="https://vk.com/mvariant_ru" target="_blank" rel="nofollow"><img
                                src="https://mvariant.ru/images/vk.png" alt="Вконтакте"></a>
